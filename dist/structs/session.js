...
class Session {
    constructor(sess) {
        ...
        const fee = utils_1.extractIndexOrProperty("session", sess, idx++, "fee", utils_1.isNumeric);
        this.fee = `${fee}`;
        const nonce = utils_1.extractIndexOrProperty("session", sess, idx++, "nonce", utils_1.isDefined);
        this.nonce = `${nonce}`;
