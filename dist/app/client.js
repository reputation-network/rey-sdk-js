...
class AppClient {
    ...
    extraReadPermissions() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const directDependencies = yield Promise.all(manifest.app_dependencies.map((dep) => __awaiter(this, void 0, void 0, function* () {
                const depClient = new AppClient(dep, this.opts);
                const depManifestEntry = yield depClient.manifestEntry();
    ...
    query(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const output = safe_buffer_1.Buffer.from(res.data).toString();
            ...
            struct_validations_1.validateSignature(utils_1.reyHash([output]), utils_1.normalizeSignature(signature), params.request.readPermission.source);
